...
- [#549](https://github.com/sgmap/pix/pull/549) [FEATURE] Ajouter une route attrape-tout pour rediriger les erreurs 404 vers la page d'accueil (US-818). 
- [#544](https://github.com/sgmap/pix/pull/544) [BUGFIX] Les tests adaptatifs sont rafraîchis automatiquement (US-804).
- [#533](https://github.com/sgmap/pix/pull/533) [BUGFIX] Fixer le niveau maximal atteignable au cours d'une évaluation à 5 (US-783).
- [#546](https://github.com/sgmap/pix/pull/546) [BUGFIX] La liste des profils partagés doit s'actualiser à chaque chargement de la page /board (US-754). 
